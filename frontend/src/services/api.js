...
export const userService = {
    ...
    updateProfile: (email, userData) => axios.put(`${BASE_URL}/api/profile/${email}`, userData, { withCredentials: true }),
};
...
export const approvalService = {
    submitForApproval: (payload) => axios.post(`${BASE_URL}/api/submit-for-approval`, payload, { withCredentials: true }),
};
