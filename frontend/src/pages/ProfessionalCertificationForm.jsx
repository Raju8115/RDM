...
const ProfessionalCertificationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const userRes = await axios.get('https://rdm-backend-1-raju-a-dev.apps.rm3.7wse.p1.openshiftapps.com/api/user', { withCredentials: true });
      const userId = userRes.data.id;
      await axios.post('https://rdm-backend-1-raju-a-dev.apps.rm3.7wse.p1.openshiftapps.com/api/professional-certifications', {
        userId,
        title: form.title,
