...
const AncillaryFormPage = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const res = await axios.get('https://rdm-backend-1-raju-a-dev.apps.rm3.7wse.p1.openshiftapps.com/api/user', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `https://rdm-backend-1-raju-a-dev.apps.rm3.7wse.p1.openshiftapps.com/api/user/${userEmail}/ancillary-skill`,
        {
